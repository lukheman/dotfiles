...
hl.config({
	general = {
		...
		col = {
			active_border = { colors = { "rgba(67b0e8aa)" }, angle = 45 },
...
-- custom
-- Toggle Waybar (Sembunyikan / Tampilkan)
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("killall -SIGUSR1 waybar"))
hl.bind("SUPER + P", hl.dsp.exec_cmd('grim -g "$(slurp -d)" - | wl-copy'))
hl.bind("SUPER + M", hl.dsp.exec_cmd("~/.config/hypr/scripts/awww-main-wallpapers.sh"))
